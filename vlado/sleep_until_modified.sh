#!/bin/bash
# All rights belong to Denilson Sá
# https://bitbucket.org/denilsonsa/small_scripts/src/31cfffd4e456eff2a561c64784d6274b3561a07f/sleep_until_modified.sh?at=default&fileviewer=file-view-default
